var clientClass = function(prop) {
	this.prop = "I am client class !!";
};
...
console.log(ins1.constructor === clientClass);
console.log(ins1.constructor);
console.log(ins2.constructor === clientClass2);
