...
(function() {
	...
	RemoteObject.prototype.sendMessage = function(msgObj, callback) {
		...
		socket.on('octopus_return_'+this.objectId+'_'+invocationId, function(remObjData) {
			if (callback)
				callback( remObjData.isPrimitive ? remObjData.value : manager.getRemoteObject(remObjData) );
		});
	};
	RemoteObject.prototype.get_cps = function(prop, callback) {
		this.sendMessage({type:'get', prop:prop}, callback);
	};
	RemoteObject.prototype.set_cps = function(prop, value, callback) {
